------------------------ MODULE completion_port_fixed ----------------------
(*
 * FIXED version of the CompletionPort protocol.
 *
 * Fix: set thread state to Blocked WHILE STILL HOLDING the port lock.
 * Check + set_waiter + mark_blocked are all in one atomic step.
 *)
...
(*--algorithm completion_port_fixed
...
\* BEGIN TRANSLATION (chksum(pcal) = "d0f7a0c" /\ chksum(tla) = "87ba42a5")
